...
subroutine STATISTICS_NSPP( time, dt, u, g, x0, dx, stage, work, mask )
    ...
    case ("post_stage")
        ...
        params_nspp%mean_flow = params_nspp%mean_flow / get_active_domain_length(params_nspp%domain_size, params_nspp%domain_cropping_min, params_nspp%domain_cropping_max, dir=merge('xyz', 'xy ', params_nspp%dim==3))
        ...
        if (params_nspp%time_statistics) then
            ...
            params_nspp%time_statistics_mean = params_nspp%time_statistics_mean / get_active_domain_length(params_nspp%domain_size, params_nspp%domain_cropping_min, params_nspp%domain_cropping_max, dir=merge('xyz', 'xy ', params_nspp%dim==3))
        ...
        if (params_nspp%mpirank == 0) then
            ...
            if (params_nspp%nu*params_nspp%enstrophy > 0.0_rk .and. params_nspp%HIT_linear_forcing) then
                ...
                dissipation = params_nspp%dissipation/get_active_domain_length(params_nspp%domain_size, params_nspp%domain_cropping_min, params_nspp%domain_cropping_max, dir=merge('xyz', 'xy ', params_nspp%dim==3))
                u_RMS = sqrt(2.0_rk*params_nspp%e_kin/get_active_domain_length(params_nspp%domain_size, params_nspp%domain_cropping_min, params_nspp%domain_cropping_max, dir=merge('xyz', 'xy ', params_nspp%dim==3))/3.0_rk)
                call append_t_file( 'turbulent_statistics.t', (/time, dissipation, params_nspp%e_kin/get_active_domain_length(params_nspp%domain_size, params_nspp%domain_cropping_min, params_nspp%domain_cropping_max, dir=merge('xyz', 'xy ', params_nspp%dim==3)), u_RMS, &
