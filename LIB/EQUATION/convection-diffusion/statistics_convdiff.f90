...
subroutine STATISTICS_convdiff( time, dt, u, g, x0, dx, stage)
    ...
    case ("post_stage")
        ...
        if (params_convdiff%time_statistics) then
            ...
            params_convdiff%time_statistics_mean = params_convdiff%time_statistics_mean / product(params_convdiff%domain_size(1:params_convdiff%dim) * (params_convdiff%domain_slice_max(1:params_convdiff%dim) - params_convdiff%domain_slice_min(1:params_convdiff%dim)))
